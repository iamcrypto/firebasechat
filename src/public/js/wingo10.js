...
$('.van-overlay').click(function (e) {
  e.preventDefault();
  $(".van-overlay, .pop-qt, .pop-quytac-buy, .popup-qt").fadeOut(200);
});
          ...
          $(".foot .right").click(function (e) {
            ...
            $.ajax({
              ...
              success: function (response) {
                ...
                socket.emit('data-server_2', {money: total,bet_amount: x * money, join, time: Date.now(), change: response.change, game:"10" });
              },
            });
